import { domElements, domStrings } from "./base";
        ...
        <figure class="recipe__fig">
            ...
            <div class="recipe__details">
                <div class="recipe__info">
                    ...
                    <span class="recipe__info-data recipe__info-data--minutes">${recipe.timeToCook}</span>
            ...
            <div class="recipe__ingredients">
                <ul class="recipe__ingredient-list">
                    ${recipe.ingredients.map(curr => createIngredient(curr)).join('')}
                </ul>
